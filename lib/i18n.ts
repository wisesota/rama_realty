    ...
    architecture: {
      ...
      boundaries: {
        ...
        items: [
          ...
          { title: "Voice privacy", body: "Rama does not persist raw audio. Gemini processes the live turn; reconnect retention stays off unless separately approved and disclosed.", state: "privacy" },
    ...
    architecture: {
      ...
      boundaries: {
        ...
        items: [
          ...
          { title: "خصوصية الصوت", body: "لا تحفظ راما الصوت الخام. يعالج Gemini المحادثة المباشرة، وتبقى ميزة الاحتفاظ لإعادة الاتصال معطلة ما لم تُعتمد وتُوضّح بشكل منفصل.", state: "privacy" },
