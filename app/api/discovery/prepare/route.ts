...
export async function POST(request: Request) {
  ...
  try {
    ...
    return errorResponse("The request body could not be read.", 400, "InvalidRequest");
  }
  ...
  let body: unknown;
  try { body = JSON.parse(text); } catch { return errorResponse("The request body must be valid JSON.", 400, "InvalidJson"); }
