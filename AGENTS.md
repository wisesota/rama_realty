...
- Preserve the approved Editorial Property Atelier design: an airy gallery canvas, Source Serif 4 plus Instrument Sans, restrained sky-blue and sand accents, 16px editorial media corners, compact 6–8px controls, generous whitespace, and the project-owned `public/images/rama-hero-editorial-daylight.png` plus `public/lottie/ai.json`. Keep the desktop hero heading on one line. Avoid decorative curves, pill-heavy SaaS chrome, glass effects, generic orbs, fabricated credibility claims, and invented live inventory.
